...
public class Filme
{
    ...
    [JsonPropertyName("image")] public string? LinkImagem { get; set; }

    [JsonPropertyName("crew")] public string? Equipe { get; set; }

    [JsonPropertyName("imDbRating")] public string? Nota { get; set; }

    [JsonPropertyName("imDbRatingCount")] public string? QuantidadeAvaliacao { get; set; }
}